...
router.post('/', authJwt.authenToken, authJwt.isAdmin, uploadBooking.single('image'), doctorController.createDoctor);
router.put('/:id', authJwt.authenToken, authJwt.isAdminOrYourself, uploadBooking.single('image'), doctorController.updateDoctor);

...
router.post('/', authJwt.authenToken, authJwt.isAdmin,uploadBooking.single('image'),clinicController.createClinic);
...
router.put('/:id',authJwt.authenToken, authJwt.isAdmin, uploadBooking.single('image'),clinicController.updateClinic);
